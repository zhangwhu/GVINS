...
class ReprojectionFactor : public ceres::SizedCostFunction<2, 7, 7, 7, 1, 1> {      //残差的大小
...
public:
    ...
    bool Evaluate(const double *const *parameters, double *residuals, double **jacobians) const override {          
        ...
        Eigen::Vector3d pts_0_td = pts0_ - (td - td0_) * vel0_;     // 归一化平面上的位置
        Eigen::Vector3d pts_1_td = pts1_ - (td - td1_) * vel1_;

        Eigen::Vector3d pts_c_0 = pts_0_td / id0;                   // 三维坐标
